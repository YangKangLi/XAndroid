...
abstract class XDialog : DialogFragment() {
     ...
     * 转换视图
     */
    abstract fun convertView(holder: ViewHolder?, dialog: XDialog?)
    ...
    open fun setMargin(margin: Int): XDialog {
        this.margin = margin
        return this
    }

    open fun setWidth(width: Int): XDialog {
        this.width = width
        return this
    }

    open fun setHeight(height: Int): XDialog {
        this.height = height
        return this
    }

    open fun setDimAmount(dimAmount: Float): XDialog {
        this.dimAmount = dimAmount
        return this
    }

    open fun setGravity(gravity: Int): XDialog {
        this.gravity = gravity
        return this
    }

    open fun setOutCancel(outCancel: Boolean): XDialog {
        this.outCancel = outCancel
        return this
    }

    open fun setAnimStyle(@StyleRes animStyle: Int): XDialog {
        this.animStyle = animStyle
        return this
    }

    open fun show(manager: FragmentManager): XDialog {
